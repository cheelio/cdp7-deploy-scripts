        ...
        if rcg.role_type == 'REPORTSMANAGER':
            rcg_instance.update_config(rcg.name, message=None,
                                       body=cm_client.ApiConfigList([
                                           ...
                                           {'name': 'headlamp_database_password', 'value': dbpassword},
...
if __name__ == "__main__":
    ...
    optp.add_option("-d", "--dbuser",       dest="dbuser",       help="DB User")
    optp.add_option("-e", "--dbpassword",   dest="dbpassword",   help="DB Password")
